...
#include <stdio.h>              // Required for: FILE, fopen(), fclose(), fread()
    ...
    #include "stb/stb_vorbis.h"    // OGG loading functions
#endif
...
void SetAudioBufferPitch(AudioBuffer *audioBuffer, float pitch)
{
    ...
    audioBuffer->pitch /= newOutputSampleRate / (float)audioBuffer->dsp.src.config.sampleRateOut;
...
{
    ((AudioBuffer *)(sound.audioBuffer))->looping = toggle;
}
